 ...
 * my program.         
 *****************************************************************/
public class NoRepairsDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			NoRepairsDialog dialog = new NoRepairsDialog();
	...
	public NoRepairsDialog() {
		...
		{
			JLabel lblNewLabel = new JLabel("No Repairs Available");
